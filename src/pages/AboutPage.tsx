...
const AboutPage = () => {
  ...
  return (
    <>
      <SEO 
        pageType="about"
        customTitle="Über Martina Domeniconi | Zertifizierte Mindset Coach Zürich"
        customDescription="Lernen Sie Martina Domeniconi kennen - Ihre zertifizierte Mindset Coach aus Zürich. Erfahrung in Persönlichkeitsentwicklung, Transformation und ganzheitlichem Life Coaching."
      />
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <main className="pt-20">
          ...
          <ContentErrorBoundary sectionName="About">
            <About />
