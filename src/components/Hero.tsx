          ...
          <div className="max-w-2xl w-full text-center lg:text-left">
            <div className="mb-10">
              <EditableText
                ...
                defaultContent="<span className='bg-gradient-to-r from-moss via-petrol to-forest bg-clip-text text-transparent'>Mindset Coaching</span> für ein glückliches und erfülltes Leben"
                tag="h1"
                className="font-serif text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight mb-6 transition-all duration-700 ease-out opacity-0 translate-y-10 text-center sm:text-left"
              />
                ...
                <div className="relative w-full max-w-md mx-auto">
                  <div className="aspect-[3/4] overflow-hidden shadow-xl transition-all duration-500 hover:shadow-2xl rounded-lg">
                    <div className="image-reveal reveal w-full h-full relative">
                      <EditableImage
                        pageId="hero"
                        contentKey="mobile-hero-image"
                        defaultSrc="/lovable-uploads/7b4f0db6-80ea-4da6-b817-0f33ba7562b5.png"
              ...
              <EditableText
                pageId="hero"
                contentKey="subtitle"
                defaultContent="Entfalte dein volles Potenzial und erschaffe das Leben, von dem du träumst. Mit dem richtigen Mindset sind deinen Möglichkeiten keine Grenzen gesetzt."
                tag="p"
                className="text-lg md:text-xl text-foreground/90 mb-8 max-w-xl mx-auto lg:mx-0 text-center lg:text-left transition-all duration-700 ease-out opacity-0 translate-y-10 delay-100"
              />

              <EditableText
                pageId="hero"
                contentKey="additional-text"
                defaultContent="Das zentrale Thema bei Mindset Coaching sind deine persönlichen Überzeugungen und Glaubenssätze. Wovon du selber überzeugst bist, verwirklichst du in deinem Leben. In einem persönlichen Coaching lernst du deine negativen Glaubenssätze zu erkennen und abzulegen und stattdessen in jedem Lebensbereich bestärkende Glaubenssätze zu entwickeln. Dazu gehört auch ein positives Selbstbild aufzubauen und in den inneren Frieden mit dir, deinen Mitmenschen, deiner Vergangenheit und deiner Geschichte zu kommen."
                tag="p"
                className="text-base text-foreground/80 mb-8 max-w-xl mx-auto lg:mx-0 text-center lg:text-left transition-all duration-700 ease-out opacity-0 translate-y-10 delay-200"
              />
