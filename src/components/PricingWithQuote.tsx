...
const PricingWithQuote = () => {
  ...
  // Use image bridge for the Einstein image
  const einsteinImageUrl = useImageBridge('pricing-einstein', '/lovable-uploads/8a4be257-655e-4d69-b10e-5db95864ae5a.png');
