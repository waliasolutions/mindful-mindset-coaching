  ...
  return <section id="services" ref={sectionRef} className="section-padding relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto mb-16 reveal-element">
          ...
          <p className="text-lg text-center text-foreground/80 max-w-2xl mx-auto">In einem 1:1 Coaching löst du Blockaden, bringen Klarheit in dein Gedanken-Karussell und richten deinen Fokus auf das, was wirklich zählt: Deine Träume, Deine Lebenszufriedenheit und Deine innere Ruhe und Gelassenheit.</p>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <a href="#contact" className="inline-flex items-center justify-center px-6 py-3 bg-forest text-white hover:bg-forest/90 transition-colors shadow-lg font-medium rounded-md">
            Kontaktiere mich
          </a>
        </div>
      </div>
