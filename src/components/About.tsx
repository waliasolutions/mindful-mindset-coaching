      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          <div className={`reveal-right ${isVisible ? 'revealed' : ''} space-y-4 sm:space-y-5 md:space-y-6`}>
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground/80 leading-relaxed">
              Mein Ziel ist es, das Wissen, das ich in dieser Ausbildung erlernt habe, weiterzugeben, damit auch <span className="text-primary font-medium">du dein wahres Potenzial entfalten und deinen Herzensweg mit Freude und Gelassenheit gehen kannst</span>.
            </p>
            ...
            <div className="p-4 sm:p-5 md:p-6 bg-card backdrop-blur-sm shadow-sm border-l-2 border-moss rounded-r-md">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <p className="text-primary font-medium text-sm sm:text-base md:text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 mt-12 sm:mt-16 md:mt-20">
          <div className="reveal-element">
            <div className="bg-card p-4 sm:p-5 md:p-6 lg:p-7 shadow-md h-full flex flex-col items-center text-center rounded-md border-b-2 border-moss hover:shadow-lg transition-shadow duration-300">
              <Award size={28} className="text-primary mb-3 sm:mb-4" />
          ...
          <div className="reveal-element delay-100">
            <div className="bg-card p-4 sm:p-5 md:p-6 lg:p-7 shadow-md h-full flex flex-col items-center text-center rounded-md border-b-2 border-moss hover:shadow-lg transition-shadow duration-300">
              <BookOpen size={28} className="text-primary mb-3 sm:mb-4" />
          ...
          <div className="reveal-element delay-200">
            <div className="bg-card p-4 sm:p-5 md:p-6 lg:p-7 shadow-md h-full flex flex-col items-center text-center rounded-md border-b-2 border-moss hover:shadow-lg transition-shadow duration-300">
              <Users size={28} className="text-primary mb-3 sm:mb-4" />
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 text-center">
          <a href="#services" className="inline-flex items-center justify-center px-4 sm:px-5 md:px-6 lg:px-8 py-2.5 sm:py-3 md:py-3.5 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-lg font-medium rounded-md text-sm sm:text-base md:text-lg min-h-[44px] touch-manipulation">
